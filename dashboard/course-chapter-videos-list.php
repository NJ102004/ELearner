<?php
    ...
    $chapterIDforVIDEO = $_GET["chapter"]; 
                            ...
                            <table class="table  datanew">
                                ...
                                <tbody>
                                    ...
                                    <tr>                
                                        ...
                                        <?php echo "<td>" . $row["video_name"] . "</td>"; ?>
                                        <?php echo "<td>" . $row["video_plays"] . "</td>"; ?>
                                        <td>
                                            <!-- <a href="course-add-video.php?course=<?php echo $courseIDforCHAPTER;?>&chapter=<?php echo$chapterIDforVIDEO;?>" class="card-link">
                                                <img src="assets/img/icons/plus.svg" alt="img">
                                            </a> -->
                                             <a href="course-edit-video.php?course=<?php echo $_GET["course"] . "&chapter=" . $_GET["chapter"] . "&video=" . $row["video_id"];?>">
                                                <img src="assets/img/icons/edit.svg" alt="img">
                                            </a> 
                                            <a href="confirmation.php?course=<?php echo $_GET["course"] . "&chapter=" . $_GET["chapter"] . "&video=" . $row["video_id"];?>">
